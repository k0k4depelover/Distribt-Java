package com.distrubuited.systems.msvc_suscribtions.Config;
...
public class RabbitMQConfig {
    ...
    @Bean
    public Binding suscriptionBinding(Queue suscriptionQueue, TopicExchange suscriptionExchange){
    ...
    @Bean
    public Binding unsuscriptionBinding(Queue unsuscriptionQueue, TopicExchange suscriptionExchange){
